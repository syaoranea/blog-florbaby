...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                id: 6,
                label: 'MENUITEMS.DASHBOARD.LIST.POSTAGENS',
                link: '/admin/postagens',
                parentId: 2
            },
            {
                id: 7,
                label: 'MENUITEMS.DASHBOARD.LIST.CATEGORIAS',
                link: '/admin/categorias',
                parentId: 2
            },
            {
                id: 4,
                label: 'MENUITEMS.DASHBOARD.LIST.GALERIA',
                link: '/admin/galeria',
                parentId: 2
            },
            {
                id: 0,
                label: 'MENUITEMS.DASHBOARD.LIST.TAGS',
                link: '/admin/tags',
                parentId: 2
            }
        ]
