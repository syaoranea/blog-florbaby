...
import { ListJs } from '../../../core/data/table-listjs';
...
function matches(country: ListJsModel, term: string, pipe: PipeTransform) {
  return country.title?.toLowerCase().includes(term.toLowerCase())
    || country.descricao?.toLowerCase().includes(term.toLowerCase())
    || country.autor?.toLowerCase().includes(term.toLowerCase())
    || country.createdAt?.toLowerCase().includes(term.toLowerCase())
    || country.categoria?.toLowerCase().includes(term.toLowerCase())
    || country.nome?.toLowerCase().includes(term.toLowerCase());
